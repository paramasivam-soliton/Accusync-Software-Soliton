...
namespace AccuSync.Core.Abstractions.Services
{
    ...
    public class AuthenticationResult
    {
        ...
        /// <summary>True when the credentials are valid but the password is 90+ days old.
        /// Set only alongside <see cref="Success"/> = <c>true</c> — expiry is a forced
        /// reset, not a login failure, the same way first-login is.</summary>
