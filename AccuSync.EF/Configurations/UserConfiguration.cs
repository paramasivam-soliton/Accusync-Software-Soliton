...
namespace AccuSync.EF.Configurations
{
    ...
    public class UserConfiguration : IEntityTypeConfiguration<User>
    {
        ...
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            // ProfileId's id values are defined to match UserRole's underlying values exactly
            // (see UserRole and Profile remarks) — no navigation property is needed since no
            // caller currently reads a Profile's own fields (e.g. Name) through a User.
