...
namespace AccuSync.WPF.DependencyInjection
{
    ...
    public static class WpfServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddWpfServices(this IServiceCollection services)
        {
            ...
            services.AddSingleton<InactivityTimer>();
            services.AddSingleton<AutoLogoutCoordinator>();
        ...
        private static string ResolveDatabasePath(IConfiguration configuration)
        {
            ...
            catch (Exception ex) when (ex is IOException or UnauthorizedAccessException or ArgumentException or NotSupportedException)
            {
                ...
                MessageBox.Show(
                    string.Format(Strings.WpfServiceCollectionExtensions_DatabaseFolderErrorMessage, databasePath, ex.Message),
                    Strings.WpfServiceCollectionExtensions_DatabaseFolderErrorCaption, MessageBoxButton.OK, MessageBoxImage.Error);
                Environment.Exit(1);
            }
